...
public class Deform {
	...
	public static class Parameters {
		...
		@Parameter(names={"--infile1", "-i1"}, description = "input CREMI-format HDF5 file name")
		public String inFile1;
		
		@Parameter(names={"--infile2", "-i2"}, description = "input CREMI-format HDF5 file name")
		public String inFile2;
		
		@Parameter(names={"--outfile", "-o"}, description = "output CREMI-format HDF5 file name")
		public String outFile;
		
		@Parameter(names={"--dset1", "-d1"}, description = "input CREMI-format HDF5 raw dset name")
		public String dset1 = "raw";
		
		@Parameter(names={"--dset2", "-d2"}, description = "input CREMI-format HDF5 seg dset name")
		public String dset2 = "neuron_ids";
	...
	// final static private int[] cellDimensions = new int[] { 100,1 };
	...
	public static void main(String[] args) throws IOException {
		...
		String labelsDataset = params.dset1; //"neuron_ids";
		String rawDataset = params.dset2; //"raw";
		
		
		//////////////////////// start with reader ///////////////////////////
		System.out.println("Opening " + params.inFile1);
		final IHDF5Reader reader1 = HDF5Factory.openForReading(params.inFile1);
		final IHDF5Reader reader2 = HDF5Factory.openForReading(params.inFile2);

		// support both file_format 0.0 and >=0.1
		final String volumesPath = reader1.isGroup("/volumes") ? "/volumes" : "";
		final String labelsPath = reader1.isGroup(volumesPath + "/labels") ? volumesPath + "/labels" : "";
		...
		final RandomAccessibleInterval<LabelMultisetType> labels = loadLabels(reader2, fragmentsPath);
		//////////////////////// done with reader ///////////////////////////
