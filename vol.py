...
print 'Use datatype: ', dt
d = np.fromfile(filename, dt)
# assume square
print 'First values: ', d[:10]
print 'Number of elements: ', d.shape
size = int(round(d.shape[0]**(1./3)))
print 'Computed size: ', size
data = d.reshape( (size,size,size) )
print 'Max: ', data.max()
print 'Min: ', data.min()

# TODO: change colormap to default to 'prism'
